    ...
    >
      ...
      {matchmaking ? (
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">Matches/Min</div>
          ...
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">Avg Match Time</div>
          ...
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">Failed Matches</div>
          ...
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">Success Rate</div>
            <div
