        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-black rounded-lg p-4 border border-zinc-800">
              <div className="text-zinc-400 text-sm mb-2">Environment</div>
              <div
            ...
            <div className="bg-black rounded-lg p-4 border border-zinc-800">
              <div className="text-zinc-400 text-sm mb-2">Pod Name</div>
            ...
            <div className="bg-black rounded-lg p-4 border border-zinc-800">
              <div className="text-zinc-400 text-sm mb-2">Namespace</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-black rounded-lg p-4 border border-zinc-800">
              <div className="text-zinc-400 text-sm mb-2">Cluster</div>
            ...
            <div className="bg-black rounded-lg p-4 border border-zinc-800">
              <div className="text-zinc-400 text-sm mb-2">Node</div>
            ...
            <div className="bg-black rounded-lg p-4 border border-zinc-800">
              <div className="text-zinc-400 text-sm mb-2">Pod IP</div>
              <div className="text-sm font-mono text-zinc-300">{k8s.podIP}</div>
            </div>
          </div>
        </div>
      ) : (
