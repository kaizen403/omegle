    ...
    >
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          <div className="bg-black rounded-lg p-3 sm:p-4 border border-zinc-800">
          ...
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">Active Rooms</div>
          ...
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">Queue Size</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">Memory RSS</div>
            {memory ? (
              <>
          ...
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">Heap Total</div>
            {memory ? (
              <>
          ...
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">External Memory</div>
            {memory ? (
          ...
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">Array Buffers</div>
            {memory ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">CPU User Time</div>
            {cpu?.user ? (
          ...
          <div className="bg-black rounded-lg p-4 border border-zinc-800">
            <div className="text-zinc-400 text-sm mb-2">CPU System Time</div>
            {cpu?.system ? (
